...
export default function Navvv() {
  ...
  <Link className="font-semibold text-lg text-black hover:text-blue" to="/" aria-current="page">Home</Link>
  <Link className="font-semibold text-lg text-black hover:text-blue" to="/community">Community</Link>
  <a className="font-semibold text-lg text-black hover:text-blue" href="/blogs">Blogs</a>
  <a className="font-semibold text-lg text-black hover:text-blue" href="/mentorship">Mentors</a>
